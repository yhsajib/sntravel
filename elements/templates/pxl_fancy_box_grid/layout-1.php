...
if(is_admin())
    ...
    $grid_class = 'sntravel-grid-inner sntravel-grid-masonry row relative';

?>
<?php if(isset($content_list) && !empty($content_list) && count($content_list)): ?>
    <div class="sntravel-grid sntravel-fancy-box-grid layout-1" data-layout-mode="fitRows">
                    ...
                    <div class="item-inner elementor-repeater-item-<?php echo esc_attr($value['_id']); ?>">
                        <?php if(!empty($thumbnail)) { ?>
                            <div class="item-image">
                                <div class="image-wrap" <?php sntravel_print_html($widget->get_render_attribute_string( 'sntravel_img_wrap' )); ?>>
                        ...
                        <div class="item-content">
                            ...
                            <?php if(!empty($categories)) { ?>
                                <div class="item-categories"><?php echo sntravel_print_html($categories); ?></div>
                            <?php } ?>
                        </div>
                    </div> 
                </div>
