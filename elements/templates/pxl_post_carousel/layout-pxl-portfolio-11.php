...
<div class="pxl-swiper-slider pxl-portfolio-carousel layout-<?php echo esc_attr($settings['layout']);?> ">
    ...
    <div class="pxl-swiper-slider-wrap pxl-carousel-inner relative d-flex">
        <div class="pxl-swiper-arrow pxl-swiper-arrow-prev"><?php echo esc_html('Previous', 'sntravel'); ?></div>
        ...
        <div class="pxl-swiper-arrow pxl-swiper-arrow-next"><?php echo esc_html('Next', 'sntravel'); ?></div>
