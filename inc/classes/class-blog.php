<?php
if (!class_exists('Sntravel_Blog')) {
    class Sntravel_Blog
    {
        public function get_post_feature()
        {
            if (!has_post_thumbnail()) return;
            $post_feature_image_type = sntravel()->get_theme_opt('post_feature_image_type', 'cropped');
        ...
        {
            $archive_category = sntravel()->get_theme_opt('archive_category', true);
            $post_comments_on = sntravel()->get_theme_opt('post_comments_on', true);
            $archive_author = sntravel()->get_theme_opt('archive_author', true);
            $archive_date = sntravel()->get_theme_opt( 'archive_date', true );
                ...
                <div class="post-metas">
                    <div class="meta-inner d-flex align-items-center">
                        <?php if ($archive_author) : ?>
                            <span class="post-author col-auto d-flex"><span><?php echo esc_html__('Written by', 'sntravel'); ?> <?php the_author_posts_link(); ?></span></span>
                        <?php endif; ?>
        ...
        public function get_archive_meta_luxury($post_id = 0)
        {
            ...
            $archive_author = sntravel()->get_theme_opt('archive_author', true);
            $archive_date = sntravel()->get_theme_opt('archive_date', true );
            $archive_tag = sntravel()->get_theme_opt('archive_tag', false );
                        ...
                        <div class="author-date-wrapper d-flex">
                            ...
                            <?php if ($archive_date) : ?>
                                <span class="post-date">
                                    <?php echo get_the_date($post_id) . esc_html(' at ', 'sntravel') . get_the_time($post_id); ?>
                                </span>
                            <?php endif; ?>
                        </div>
                        <?php if ($archive_category && has_category('', $post_id)) : ?>
        ...
        {
            $post_author_on = sntravel()->get_theme_opt('post_author_on', true);
            $post_date_on = sntravel()->get_theme_opt('post_date_on', true);
            $post_comments_on = sntravel()->get_theme_opt('post_comments_on', true);
            $post_categories_on = sntravel()->get_theme_opt('post_categories_on', true);
            $post_tags_on = sntravel()->get_theme_opt('post_tag', false);
        ...
        public function get_excerpt_more($length = 25, $post = null)
        {
            ...
            if (post_password_required($post)) {
                return esc_html__('Post password required.', 'sntravel');
            }
                ...
                <div class="post-metas">
                    <div class="meta-inner d-flex align-items-center">
                        <div class="author-date-wrapper d-flex">
                            ...
                            <?php if ($post_date_on) : ?>
                                <span class="post-date">
                                    <?php echo get_the_date() . esc_html(' at ', 'sntravel') . get_the_time(); ?>
                                </span>
                            <?php endif; ?>
                        </div>
                        <?php if ($post_categories_on && has_category()) : ?>
        ...
        {
            $post_tag = sntravel()->get_theme_opt('post_tag', true);
            if ($post_tag != '1') return;
            $tags_list = get_the_tag_list('<span class="label">' . esc_attr__('Tags:', 'sntravel') . '</span>', ' ');
            if ($tags_list) {
        ...
        public function get_post_share($post_id = 0)
        {
            ...
            $share_icons = sntravel()->get_theme_opt('post_social_share_icon', []);
            ...
            <div class="post-shares d-flex align-items-center">
                <span class="label"><?php echo esc_html__('Share', 'sntravel') . $count_number .':'; ?></span>
        ...
        {
            $post_navigation = sntravel()->get_theme_opt('post_navigation', false);
                        ...
                        <div class="nav-inner">
                            ...
                            <div class="col">
                                ...
                                <div class="nav-label-wrap d-flex align-items-center">
                                    <span class="nav-label"><?php echo esc_html__('Previous', 'sntravel'); ?></span>
                                </div>
                        ...
                        <div class="nav-inner">
                            <div class="col">
                                ...
                                <div class="nav-label-wrap d-flex align-items-center justify-content-end">
                                    <span class="nav-label"><?php echo esc_html__('Next', 'sntravel'); ?></span>
                                </div>
                                <div class="nav-title-wrap d-flex align-items-center d-none d-sm-flex">
        ...
        {
            $post_related_on = sntravel()->get_theme_opt('post_related_on', false);
            ...
            if ($post_related_on) {
                ...
                if (count($query_similar->posts) > 1) {
                    ...
                    $dir           = is_rtl() ? 'rtl' : 'ltr';
            ?>
                    <div class="sntravel-related-post">
                        <h3 class="widget-title"><?php echo esc_html__('Related Posts', 'sntravel'); ?></h3>
                        <div class="class" data-settings="<?php echo esc_attr($data_settings) ?>" data-rtl="<?php echo esc_attr($dir) ?>">
                            <div class="sntravel-related-post-inner sntravel-swiper-wrapper swiper-wrapper">
                                <?php foreach ($query_similar->posts as $post) :
                                    $thumbnail_url = '';
                                    if (has_post_thumbnail(get_the_ID()) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)) :
                                        $thumbnail_url = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'sntravel-blog-small', false);
                                    endif;
                                    if ($post->ID !== $current_id) : ?>
                                        <div class="sntravel-swiper-slide swiper-slide grid-item">
