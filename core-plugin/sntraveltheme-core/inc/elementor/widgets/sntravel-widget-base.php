...
class Pxl_Widget_Base extends \Elementor\Widget_Base {
    ...
    protected $title;
    protected $icon;
    protected $categories = array('sntraveltheme-core');
    protected $keywords;
	...
	public function __construct($data = [], $args = null ) {
		...
		$categories = !empty($categories) ? $categories : [ 'sntraveltheme-core' ];
	...
	protected function register_controls() {
		...
		$common_params = apply_filters("sntravel_register_widget_common_controls", $this);
		...
		do_action("sntravel_register_widget_common_controls_action", $this);
	}
            	...
            	if(isset($param['controls']) && !empty($param['controls'])){
                    ...
                    foreach ($controls as $control){
                        ...
                        elseif($control_type == 'tab'){
                            ...
                            elseif($control['type'] == 'sntravel_start_popover'){
                                $this->start_popover();
                            }
                            elseif($control['type'] == 'sntravel_end_popover'){
                                $this->end_popover();
                            }
                            else{
                            	$c_name = $control['name'];
	...
	protected function render() {
		do_action("sntravel_before_widget_render_content", $this);
        sntravel_get_template($this);
        do_action("sntravel_after_widget_render_content", $this);
	}
