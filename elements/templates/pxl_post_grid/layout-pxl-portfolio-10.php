...
$layout               = $widget->get_setting('layout_'.$post_type, 'sntravel-portfolio-1');
...
$load_more = array(
    ...
    'img_size'            => $widget->get_setting('img_size','370x472'),
...
<div <?php sntravel_print_html($widget->get_render_attribute_string( 'wrapper' )) ?>>
    ...
    <?php if ($select_post_by === 'term_selected' && $filter == "true"): ?>
        <div class="grid-filter-wrap d-flex <?php echo esc_attr($widget->get_setting('filter_alignment', 'center')); ?> <?php echo esc_attr($tab_style); ?>">
