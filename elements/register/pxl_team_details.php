            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'hi_text',
                            'label' => esc_html__('Hi Text', 'sntravel'),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'label_block' => true,
                        ),
                        array(
                            'name'        => 'item_background',
                            'label'       => esc_html__('Hi Text Background', 'sntravel'),
                            'type'        => 'media',
                            'label_block' => true,
                        ),
                        array(
                        ...
                        array(
                            'name' => 'contact_list',
                            'label' => esc_html__('Contact List', 'sntravel'),
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'contact_info',
                                    'label' => esc_html__('Contact Info', 'sntravel' ),
