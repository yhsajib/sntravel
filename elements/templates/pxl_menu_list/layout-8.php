...
<div class="sntravel-menu-list layout-8">
            ...
            <div class="sntravel-menu-item <?php echo esc_attr($animate_cls); ?> <?php echo 'elementor-repeater-item-' . $value['_id'] ?>" <?php sntravel_print_html($data_settings); ?>>
                ...
                <div class="item-content d-flex align-items-center">
                    ...
                    <div class="main-content">
                        <div class="d-flex align-items-center justify-content-between<?php echo esc_attr($value['is_featured'] == 'yes' ? ' featured' : ''); ?>">
                        ...
                        <?php if (!empty( $value['description'] )) : ?>
                            <div class="menu-description">
                                <?php echo sntravel_print_html($value['description']); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
