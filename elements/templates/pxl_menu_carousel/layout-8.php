...
$img_size = !empty($img_size) ? $img_size : '384x386';
                    ...
                    <div class="sntravel-swiper-slide swiper-slide">
                        <div class="item-inner">
                            ...
                            <div class="item-content">
                                <?php if (!empty( $value['is_featured']) && !empty( $value['featured_text'])) : ?>
                                    <div class="menu-featured">
                                        <?php echo sntravel_print_html($value['featured_text']); ?>
                                    </div>
                                <?php endif;
                                ...
                                <?php endif;
                                ?>
                                <div class="sntravel-icon">
                                    <i class="sntraveli sntraveli-knife"></i>
                                </div>
                                <?php
