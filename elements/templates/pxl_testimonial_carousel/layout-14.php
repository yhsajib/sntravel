        ...
        <?php if ($arrows !== 'false') :
                ?>
                    <div class="sntravel-swiper-arrows style-arrow-chef nav-vertical-out">
                        <div class="sntravel-swiper-arrow sntravel-swiper-arrow-prev"><span class="arrow-text">previours</span></div>
                        <div class="sntravel-swiper-arrow sntravel-swiper-arrow-next"><span class="arrow-text">next</span></div>
                    </div>
                <?php
        endif; ?>
        <div class="sntravel-swiper-dots <?php echo esc_attr($pagination_style); ?>"></div>
    </div>
</div>
<?php endif; ?>