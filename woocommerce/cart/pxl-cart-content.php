	...
	<div class="cart-content-inner">
		<div class="cart-list-head">
			<div class="row gx-20">
				...
				<div class="col"> 
					<div class="row gx-20">
						<div class="col-name col"><span class="product-name"><?php esc_html_e( 'Product', 'sntravel' ); ?></span></div>
						<div class="col-price col-2"><?php esc_html_e( 'Price', 'sntravel' ); ?></div>
						<div class="col-quantity col-3"><?php esc_html_e( 'Quantity', 'sntravel' ); ?></div>
						<div class="col-subtotal col-2"><?php esc_html_e( 'Subtotal', 'sntravel' ); ?></div>
			...
			<?php foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) : ?>
				...
				<div class="cart-list-item row gx-0 <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					<div class="cart-item-thumbnail col-auto">
						<?php $image_border = sntravel()->get_theme_opt('image_product_border', '0'); ?>
						...
						<div class="cart-item-info-inner row gx-20">
							<div class="item-name col-12 col-sm">
								...
								if ( $_product->backorders_require_notification() && $_product->is_on_backorder( $cart_item['quantity'] ) ) {
									echo wp_kses_post( apply_filters( 'woocommerce_cart_item_backorder_notification', '<p class="backorder_notification">' . esc_html__( 'Available on backorder', 'sntravel' ) . '</p>', $product_id ) );
								}
								?>
							</div>
							...
							<div class="item-subtotal col-12 col-sm-2">
								<span class="lbl d-sm-none"><?php esc_html_e( 'Subtotal: ', 'sntravel' ) ?></span>
								<?php
								...
								<?php
									echo apply_filters( 
										...
										sprintf(
											...
											esc_attr( sprintf( __( 'Remove %s from cart', 'sntravel' ), $product_name ) ),
											esc_attr( $product_id ),
