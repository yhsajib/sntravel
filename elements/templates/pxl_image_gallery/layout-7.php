...
$img_size = !empty($img_size) ? $img_size : '800x930';
...
?>
<div class="sntravel-grid sntravel-image-gallery images-light-box layout-7" data-layout-mode="<?php echo esc_attr($layout_mode); ?>">
                ...
                <?php if (!empty($image)) : ?>
                    <div class="item-inner">
                        ...
                        <div class="up-icon">
                            ...
                            ?>
                            <a <?php sntravel_print_html($link_attributes); ?>>
