...
?>
<div class="sntravel-checkout-content-wrap">
	<?php do_action( 'woocommerce_before_checkout_form', $checkout ); ?>
	<?php 
		if ( !$checkout->is_registration_enabled() && $checkout->is_registration_required() && ! is_user_logged_in() ) {
			echo esc_html( apply_filters( 'woocommerce_checkout_must_be_logged_in_message', __( 'You must be logged in to checkout.', 'sntravel' ) ) );
			return;
		}
	?>
	<?php 
	...
	<form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
		<div class="sntravel-checkout-wrap row">
			...
			<div class="checkout-col-right col-12 col-lg-5">
				<div class="checkout-review-wrap">
					<div class="checkout-review-inner">
						...
						<h4 id="order_review_heading" class="sntravel-heading order-review-heading"><?php esc_html_e( 'Your order', 'sntravel' ); ?></h4>
