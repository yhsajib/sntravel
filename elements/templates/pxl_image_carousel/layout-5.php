...
<div class="sntravel-swiper-slider sntravel-image-carousel layout-5">
    ...
    <div class="sntravel-swiper-slider-wrap sntravel-carousel-inner relative">
        ...
        <?php basilico_arrow_template($settings, 'sntraveli sntraveli-left-arrow', 'sntraveli sntraveli-right-arrow'); ?>
