...
if (!class_exists('SNTRAVEL_Redux_Fields_sntravel_auto_generate')) {

    class SNTRAVEL_Redux_Fields_sntravel_auto_generate {
        ...
        public $field_name = 'sntravel_auto_generate';
