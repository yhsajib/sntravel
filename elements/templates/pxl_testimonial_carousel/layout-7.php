...
$pagination_style = sntravel()->get_theme_opt('swiper_pagination_style', 'style-df');
...
<div class="sntravel-swiper-slider sntravel-testimonial-carousel d-flex justify-content-center layout-<?php echo esc_attr($settings['layout'])?>">
    <?php
    $thumb_opts = [
    ...
    ?>
    <div class="sntravel-swiper-thumbs-wrap">
        <div class="sntravel-swiper-thumbs overflow-hidden" data-settings="<?php echo esc_attr($data_thumb_settings) ?>">
            <div class="sntravel-thumbs-wrapper swiper-wrapper">
                <?php
                $idx = 0;
                foreach ($content_list as $key => $value):
                    ...
                    ?>
                    <div class="sntravel-swiper-slide thumb-item swiper-slide">
    ...
    <div class="sntravel-swiper-slider-wrap sntravel-carousel-inner d-flex justify-content-center relative" style="background-image: url(<?php echo esc_url($settings['testimonial_background']['url']); ?>);">
