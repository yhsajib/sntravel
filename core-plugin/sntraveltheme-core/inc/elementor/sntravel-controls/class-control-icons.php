...
class SntravelTheme_Core_Icons_Control extends \Elementor\Base_Data_Control {
     ...
     *
     * Retrieve the control type, in this case `sntravel_icons`.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function enqueue() {
        ...
        wp_register_script('sntravel_icons-control', SNTRAVEL_URL . 'assets/libs/iconpicker/sntravel-iconpicker.js', array('jquery', 'jquery.fonticonpicker.js'), '1.0.0');
        wp_enqueue_script( 'sntravel_icons-control' );
            ...
            <div class="elementor-control-input-wrapper">
                ...
                <div class="sntravel-group">
                    <#
                        ...
                        template += '</select></div></div></div></div><div class="elementor-control elementor-label-block"><div class="elementor-control-content"><div class="elementor-control-field"><label class="elementor-control-title"><?php esc_html_e('Url', SNTRAVEL_TEXT_DOMAIN)?></label><div class="elementor-control-input-wrapper"><input type="url" class="elementor-control-tag-area elementor-input sntravel-url-input" /></div></div></div></div></div>';
                    #>
                    ...
                    #>
                            <div class="sntravel-group-item" style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; position: relative;">
                                ...
                                <div class="elementor-control elementor-label-block">
                                    <div class="elementor-control-content">
                                        <div class="elementor-control-field">
                                            <label class="elementor-control-title"><?php esc_html_e('Url', SNTRAVEL_TEXT_DOMAIN)?></label>
                                            <div class="elementor-control-input-wrapper">
                                                <input type="url" class="elementor-control-tag-area elementor-input sntravel-url-input"  value="{{ url_val }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
