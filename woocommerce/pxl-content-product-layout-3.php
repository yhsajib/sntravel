...
<div <?php wc_product_class( '', $product ); ?>>
    <div class="sntravel-shop-item-wrap">
        <div class="sntravel-products-thumb relative">
        ...
        <div class="sntravel-products-content">
            <div class="sntravel-products-content-wrap">
                <div class="sntravel-products-content-inner">
                    <?php
                    /**
                    ...
                    ?>
                    <h3 class="sntravel-product-title">
                    ...
                    <div class="sntravel-loop-product-excerpt">
                        <?php
                    ...
                    <div class="btn-wrapper">
                        <div class="sntravel-add-to-cart">
