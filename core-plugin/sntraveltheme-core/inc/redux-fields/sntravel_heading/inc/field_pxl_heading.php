...
if ( ! class_exists( 'ReduxFramework_sntravel_heading' ) ) {
 
	class ReduxFramework_sntravel_heading {
		...
		public function __construct( $field, $value, $parent ) {
			...
			$this->extension_url = sntravel_redux_fields()->extensions_url . 'sntravel_heading/';
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'redux-field-sntravel-heading-js', $this->extension_url . 'inc/field_sntravel_heading.js', array('jquery', 'wp-color-picker','redux-js'), time(), true );
			wp_enqueue_style( 'redux-field-sntravel-heading-css', $this->extension_url . 'inc/field_sntravel_heading.css' , array(), time(), 'all' );
		}
