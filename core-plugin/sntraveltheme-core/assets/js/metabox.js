;( function( $ )
{
    ...
    SRFEMetabox.init = function()
    {
        ...
        if ( 'undefined' !== typeof SNTRAVEL_Metabox_Localize )
        {
            this.getErrors( SNTRAVEL_Metabox_Localize );
            this.getWarnings( SNTRAVEL_Metabox_Localize );
            this.postFormats( SNTRAVEL_Metabox_Localize );
        }
