...
?>
<div class="sntravel-grid sntravel-image-gallery images-light-box layout-5" data-layout-mode="<?php echo esc_attr($layout_mode); ?>">
                ...
                <?php if (!empty($image)) : ?>
                    <div class="item-inner">
                        ...
                        <div class="up-icon">
                            ...
                            ?>
                            <a <?php echo sntravel_print_html($link_attributes); ?>>
