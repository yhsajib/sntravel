...
if (!class_exists('Sntravel_Main')) {
    class Sntravel_Main extends Sntravel_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Sntravel_Main();
            }
        ...
        public function get_sidebar_args($args = []){
            ...
            $sidebars = ['content_class' => 'col-lg-8 col-xl-8', 'sidebar_class' => 'col-lg-4 col-xl-4', 'wrap_class' => 'sntravel-content-wrap'];
...
function sntravel() {
    return Sntravel_Main::getInstance();
}
// Install
sntravel();

basilico_action( 'init' );