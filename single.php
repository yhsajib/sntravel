...
$pxl_sidebar = sntravel()->get_sidebar_args(['type' => 'post', 'content_col' => '8']); // type: blog, post, page, shop, product
?>
    <div class="container">
        <div class="row <?php echo esc_attr($pxl_sidebar['wrap_class']) ?>">
            <div id="sntravel-content-area" class="<?php echo esc_attr($pxl_sidebar['content_class']) ?>">
                <main id="sntravel-content-main" class="sntravel-content-main <?php echo esc_attr($post_style); ?> <?php echo esc_attr($pxl_sidebar['sidebar_class']) ? '' : 'no-sidebar' ;?>">
