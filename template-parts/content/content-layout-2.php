...
$theme_style = sntravel()->get_theme_opt('theme_style', 'default');
?>
<article id="post-<?php the_ID(); ?>" <?php post_class(array('sntravel-archive-post', $theme_style)); ?>>
    ...
    ?>
        <div class="post-content">
            <?php sntravel()->blog->get_archive_meta_luxury(); ?>
            <h2 class="post-title">
