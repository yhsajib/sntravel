...
function basilico_get_pagination_html()
{
    try {
        if (!isset($_POST['query_vars'])) {
            throw new Exception(__('Something went wrong while requesting. Please try again!', 'sntravel'));
        }
        $query = new WP_Query(sanitize_text_field_array($_POST['query_vars']));
        ob_start();
        sntravel()->page->get_pagination($query,  true);
        $html = ob_get_clean();
        wp_send_json(
            array(
                'status' => true,
                'message' => esc_attr__('Load Successfully!', 'sntravel'),
                'data' => array(
                    'html' => $html,
...
function basilico_get_filter_html()
{
    try {
        ...
        $settings['filter_default_title'] = !empty($settings['filter_default_title']) ? $settings['filter_default_title'] : esc_html__('All', 'sntravel');
        ob_start();
...
function basilico_load_more_product_grid()
{
    try {
        ...
        if (!empty($settings['item_animation'])) {
            $animate_cls = ' sntravel-animate sntravel-invisible animated-' . $settings['item_animation_duration'];
        ...
        if ($posts->have_posts()) {
            ...
            wp_send_json(
                array(
                    'status' => true,
                    'message' => esc_html__('Load Post Grid Successfully!', 'sntravel'),
                    'data' => array(
                        'html'  => $html,
                        'paged' => $settings['paged'],
                        'posts' => $posts,
            ...
            wp_send_json(
                array(
                    'status' => false,
                    'message' => esc_html__('Load Post Grid No More!', 'sntravel')
                )
            );
        }
    } catch (Exception $e) {
...
if (!function_exists('basilico_get_post_grid')) {
    function basilico_get_post_grid($posts = [], $settings = [])
    {
            ...
            foreach ($posts as $key => $post) {
                if (!empty($grid_custom_columns[$key])) {
                    ...
                    if (!empty($grid_custom_columns[$key]['item_c_animation'])) {
                        ...
                        $anm_cls = ' sntravel-animate sntravel-invisible animated-' . $grid_custom_columns[$key]['item_c_animation_duration'];
        ...
        switch ($layout) {
            ...
            break;
            case 'post-4':
            basilico_get_post_grid_layout4($posts, $settings, $args_m);
            break;
            case 'post-5':
            basilico_get_post_grid_layout5($posts, $settings, $args_m);
            break;
            case 'post-6':
            basilico_get_post_grid_layout6($posts, $settings, $args_m);
            break;
            case 'post-7':
            basilico_get_post_grid_layout7($posts, $settings, $args_m);
            break;
            case 'post-8':
            basilico_get_post_grid_layout7($posts, $settings, $args_m);
            break;
            case 'post-9':
            basilico_get_post_grid_layout9($posts, $settings, $args_m);
            break;
            case 'post-10':
            basilico_get_post_grid_layout3($posts, $settings, $args_m);
            break;
        ...
        <div class="<?php echo esc_attr($str_item_class . ' ' . $animate_cls . ' ' . $filter_class); ?>" <?php pxl_print_html($data_settings); ?>>
            <div class="grid-item-inner">
                ...
                if (has_post_format('quote', $post->ID)) {
                    ...
                    ?>
                    <div class="sntravel-archive-post format-quote">
                            ...
                            <div class="quote-inner row">
                                <div class="inner-left col-10">
                                    ...
                                    if (!empty($quote_cite)) {
                                        ?>
                                        <p class="quote-cite">
                                            <?php echo esc_html($quote_cite) . esc_html(' - Quote', 'sntravel'); ?>
                                        </p>
                                        <?php
                                    }
                                    ?>
                    ...
                    ?>
                    <div class="sntravel-archive-post format-link">
                        <div class="format-wrap">
                            <div class="link-inner row">
                                <div class="inner-left col-10">
                                    ...
                                    <?php if (!empty($link_cite)) : ?>
                                        <p class="link-cite">
                                            <?php echo esc_attr($link_cite) . esc_html(' - Quote', 'sntravel'); ?>
                                        </p>
                                    <?php endif; ?>
                                </div>
                                <div class="inner-right col-2 d-flex justify-content-center align-items-center">
                                ...
                                <div class="meta-inner">
                                    <?php if ($show_author == 'true') : ?>
                                        <span class="post-author">
                                            <span class="label"><?php echo esc_html__('Written By', 'sntravel'); ?>&nbsp;<a href="<?php echo esc_url(get_author_posts_url($post->post_author, $author->user_nicename)); ?>"><?php echo esc_html($author->display_name); ?></a></span>
                                        </span>
                                    <?php endif; ?>
                                    <?php
                                    ...
                                    <span class="post-tags">
                                        <span class="label"><?php echo esc_html('TAGS:', 'sntravel'); ?></span>
                                        <?php if ($posttags) {
                                    ...
                                    <?php if ($show_comment == 'true') : ?>
                                        <span class="post-comments">
                                            <span class="label"><?php echo esc_html('COMMENTS:', 'sntravel'); ?></span>
                                            <a href="<?php echo get_comments_link($post->ID); ?>">
                                                <span><?php comments_number(esc_html__('No Comments', 'sntravel'), esc_html__(' 1 Comment', 'sntravel'), esc_html__(' % Comments', 'sntravel'), $post->ID); ?></span>
                                            </a>
                                        </span>
                                    <?php endif; ?>
                                    <?php ?>
                                    <span class="post-share">
                                        <span class="label"><?php echo esc_html('SHARE:', 'sntravel'); ?></span>
                                        <?php sntravel()->blog->get_post_share($post->ID); ?>
                                    </span>
                                    <?php ?>
                                </div>
                            </div>
                            ...
                            <div class="meta-inner d-flex">
                                <?php if ($show_author == 'true') : ?>
                                    <div class="post-author">
                                        <span class="label"><?php echo esc_html__('by', 'sntravel'); ?>&nbsp;<a href="<?php echo esc_url(get_author_posts_url($post->post_author, $author->user_nicename)); ?>"><?php echo esc_html($author->display_name); ?></a></span>
                                    </div>
                                <?php endif; ?>
                        ...
                        if ($show_author == 'true' || $show_comment == 'true') {
                            ...
                            <div class="post-metas">
                                <div class="meta-inner">
                                    ...
                                    <?php ?>
                                    <span class="post-share">
                                        <span class="label"><?php echo esc_html('SHARE POST:', 'sntravel'); ?></span>
                                        <?php sntravel()->blog->get_post_share($post->ID); ?>
                                    </span>
                                    <?php ?>
                                </div>
                                    ...
                                    <div class="author-date-wrapper d-flex">
                                        <?php if ($show_author) : ?>
                                            <span class="post-author col-auto d-flex">
                                                <span><?php echo esc_html__('Written by', 'sntravel'); ?> <?php the_author_posts_link(); ?></span>
                                            </span>
                                        <?php endif; ?>
                                        ...
                                        <?php if ($show_date) : ?>
                                            <span class="post-date">
                                                <?php echo get_the_date(get_option('date_format'), $post->ID) . esc_html(' at ', 'sntravel') . get_the_time(get_option('time_format'), $post->ID); ?>
                                            </span>
                                        <?php endif; ?>
                                    </div>
                                    <?php
            ...
            <?php if ($show_category == 'true' || $show_author == 'true') : ?>
                <div class="post-metas">
                    <div class="meta-inner d-flex">
                        <?php if ($show_author == 'true') : ?>
                            <span class="post-author">
                                <span class="label"><?php echo esc_html__('By', 'sntravel'); ?></span>
...
function basilico_get_post_grid_layout4($posts = [], $settings = [], $args_m = [])
{
    extract($settings);
    foreach ($posts as $key => $post) :
        $str_item_class = !empty($args_m[$key]['item_class']) ? $args_m[$key]['item_class'] : $item_class;
...
function basilico_get_post_grid_layout5($posts = [], $settings = [], $args_m = [])
{
    extract($settings);
    foreach ($posts as $key => $post) :
        $str_item_class = !empty($args_m[$key]['item_class']) ? $args_m[$key]['item_class'] : $item_class;
...
function basilico_get_post_grid_layout6($posts = [], $settings = [], $args_m = [])
{
    extract($settings);
    foreach ($posts as $key => $post) :
        $str_item_class = !empty($args_m[$key]['item_class']) ? $args_m[$key]['item_class'] : $item_class;
...
function basilico_get_post_grid_layout7($posts = [], $settings = [], $args_m = [])
{
    extract($settings);
    foreach ($posts as $key => $post) :
        $str_item_class = !empty($args_m[$key]['item_class']) ? $args_m[$key]['item_class'] : $item_class;
...
function basilico_get_post_grid_layout9($posts = [], $settings = [], $args_m = [])
{
    extract($settings);
    foreach ($posts as $key => $post) :
        $str_item_class = !empty($args_m[$key]['item_class']) ? $args_m[$key]['item_class'] : $item_class;
                    ...
                    <div class="item-content col-lg-6">
                        ...
                        if ($show_tag == 'true') {
                            ...
                            <div class="post-metas">
                                <div class="meta-inner d-flex align-items-center">
                                    <span class="post-tag">
                                        <?php the_terms($post->ID, 'sntravel-portfolio-tag', '', ',&nbsp', ''); ?>
                                    </span>
                                </div>
                            </div>
                            <?php
                    ...
                    <div class="content-inner">
                        ...
                        if ($show_category == 'true') {
                            ...
                            <div class="item-category">
                                <?php the_terms($post->ID, 'sntravel-portfolio-category', '', ', ', ''); ?>
                            </div>
                            <?php
                        }
                        ?>
                ...
                <div class="item-content">
                    <div class="content-inner">
                        ...
                        if ($show_category == 'true') {
                            ?>
                            <div class="item-tags">
                                <?php the_terms($post->ID, 'sntravel-portfolio-tag', '', ', ', ''); ?>
                            </div>
                            <?php
                        }
                        ?>
    ...
    <div class="sntravel-swiper-arrows <?php echo esc_attr($settings['arrows_style']); ?>">
        <div class="sntravel-swiper-arrow sntravel-swiper-arrow-prev <?php echo esc_attr($settings['arrow_prev_position']); ?>">
            ...
            if ( $settings['arrow_icon_previous']['value'] ) 
                \Elementor\Icons_Manager::render_icon( $settings['arrow_icon_previous'], [ 'aria-hidden' => 'true', 'class' => 'sntravel-icon'], 'span' );
            else
                echo '<span class="sntravel-icon ' . $arrow_icon_prev_cls . '"></span>';
            ?>
        </div>
        <div class="sntravel-swiper-arrow sntravel-swiper-arrow-next <?php echo esc_attr($settings['arrow_next_position']); ?>">
            <?php
            if ( $settings['arrow_icon_next']['value'] ) 
                \Elementor\Icons_Manager::render_icon( $settings['arrow_icon_next'], [ 'aria-hidden' => 'true', 'class' => 'sntravel-icon'], 'span' );
            else
                echo '<span class="sntravel-icon ' . $arrow_icon_next_cls . '"></span>';
            ?>
        </div>
    </div>
    <?php
