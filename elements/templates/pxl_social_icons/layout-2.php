<div class="sntravel-social-icons layout-2">
	<?php 
				...
				<a <?php echo implode( ' ', [ $link_attributes ] ); ?>>
					<?php endif; ?>
						<?php if(! empty( $value['social_icon']['value'] )): ?>
                            <?php \Elementor\Icons_Manager::render_icon( $value['social_icon'], [ 'aria-hidden' => 'true', 'class' => 'sntravel-fancy-icon sntravel-icon' ], 'i' );?>
                        <?php endif; ?>
