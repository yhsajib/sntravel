...
?>
<div class="sntravel-pricing-wrap layout-2 <?php if (!empty($pxl_animate)){echo esc_attr($pxl_animate);} ?> <?php echo esc_attr($settings['style']);?>" data-wow-duration="1.4s" data-wow-delay="0.25s">
    <?php
