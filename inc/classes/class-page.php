<?php
if (!class_exists('Sntravel_Page')) {
    class Sntravel_Page
    {
        public function get_site_loader(){

            $site_loader = sntravel()->get_theme_opt( 'site_loader', false );
            $site_loader_style = sntravel()->get_theme_opt('site_loader_style', 'default');
            $loader_image = sntravel()->get_theme_opt( 'loader_image', array( 'url' => '', 'id' => '' ) );

            if ($site_loader){
                switch ( $site_loader_style ) {
                    case 'gif_image': ?>
                        <div id="sntravel-loadding" class="sntravel-loader content-image">
                            <?php
                        ...
                        <?php break;
                    default: ?>
                        <div id="sntravel-loadding" class="sntravel-loader default">
        ...
        public function get_pagination( $query = null, $ajax = false ){
            ...
            $pagination_style = sntravel()->get_theme_opt('archive_pagination_style', 'style-df');
            if ( $links ):
            ?>
