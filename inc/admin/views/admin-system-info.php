<?php 
	...
	function sntravel_get_system_info() {
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Upload max file size (64MB)', 'sntravel' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Memory limit (256MB)', 'sntravel' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Post max size (64MB)', 'sntravel' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Max Execution Time (6s)', 'sntravel' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Max input vars (3000)', 'sntravel' ),
	...
	?>
		<div class="sntravel-iconbox">
			<div class="sntravel-icon-container">
				<?php if ( $item['status'] ) : ?>
					<img src="<?php echo esc_url(get_template_directory_uri()) . '/inc/admin/assets/img/check.png' ?>" alt="<?php esc_attr_e( 'Check', 'sntravel' ); ?>">
				<?php else : ?>
					<img src="<?php echo esc_url(get_template_directory_uri()) . '/inc/admin/assets/img/crossed.png' ?>" alt="<?php esc_attr_e( 'Un Check', 'sntravel' ); ?>">
				<?php endif; ?>
			</div>
			<div class="sntravel-iconbox-contents">
