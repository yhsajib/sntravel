...
class Sntravel_CSS_Generator {
	...
	function __construct() {
		$this->opt_name = sntravel()->get_option_name();
	...
	protected function get_options_output() {
        ...
        $links                           = basilico_configs('link');
        $gradients                       = basilico_configs('gradient');
        $body                            = basilico_configs('body');
        $header                          = basilico_configs('header');
