...
if (!class_exists('ReduxFramework_sntravel_iconpicker')) {
    class ReduxFramework_sntravel_iconpicker {
        public $parent;
        public $field;
        public $value;
        ...
        function __construct($field, $value, $parent) {
            ...
            $this->extension_url = sntravel_redux_fields()->extensions_url . 'sntravel_iconpicker/';
        }
        ...
        function render() {
            ...
            ?>
                <select name="<?php echo $this->field['name'] . $this->field['name_suffix']; ?>" class="sntravel-iconpicker">
                    <option value=""><?php esc_html_e('No Icons', SNTRAVEL_TEXT_DOMAIN) ?></option>
                    <?php
        ...
        public function enqueue() {
            ...
            if (!wp_script_is('jquery.fonticonpicker.js')) {
                wp_enqueue_script('jquery.fonticonpicker.js', SNTRAVEL_URL . 'assets/libs/iconpicker/jquery.fonticonpicker.min.js', array('jquery'), 'all', true);
            }
            if (!wp_script_is('sntravel-iconpicker-js')) {
                wp_enqueue_script(
                    'sntravel-iconpicker-js',
                    $this->extension_url . 'inc/field_sntravel_iconpicker.js',
        ...
        public function get_icons(){  
            ...
            $icons = apply_filters("redux_sntravel_iconpicker_field/get_icons", $icons);
