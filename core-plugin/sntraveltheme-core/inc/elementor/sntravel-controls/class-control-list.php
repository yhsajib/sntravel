...
class SntravelTheme_Core_List_Control extends \Elementor\Base_Data_Control {

    /**
     * Get emoji one area control type.
     *
     * Retrieve the control type, in this case `sntravel_lists`.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function enqueue() {
        ...
        wp_register_script('sntravel_lists-control', SNTRAVEL_URL . 'assets/libs/iconpicker/sntravel-iconpicker.js', array('jquery', 'jquery.fonticonpicker.js'), '1.0.0');
        wp_enqueue_script( 'sntravel_lists-control' );
    }
    ...
    public function content_template() {
        ...
        <div class="elementor-control-field">
            ...
            <div class="elementor-control-input-wrapper">
                ...
                #>
                <div class="sntravel-group">
                    <#
                        var template = '<div class="sntravel-group-item" style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; position: relative"><a class="sntravel-group-delete" href="#" style="position: absolute; z-index: 9; right: 10px; top: 8px;">&times;</a><div class="elementor-control elementor-label-block"><div class="elementor-control-content"><div class="elementor-control-field"><label class="elementor-control-title"><?php esc_html_e('Icon', SNTRAVEL_TEXT_DOMAIN)?></label><div class="elementor-control-input-wrapper"><select class="elementor-control-tag-area sntravel-iconpicker">';
                        template += '<option value=""><?php esc_html_e('No Icons', SNTRAVEL_TEXT_DOMAIN) ?></option>';
                        ...
                        template += '</select></div></div></div></div><div class="elementor-control elementor-label-block"><div class="elementor-control-content"><div class="elementor-control-field"><label class="elementor-control-title"><?php esc_html_e('Content', SNTRAVEL_TEXT_DOMAIN)?></label><div class="elementor-control-input-wrapper"><input type="text" class="elementor-control-tag-area elementor-input sntravel-content-input" /></div></div></div></div></div>';
                    #>
                    <textarea class="sntravel-template" style="display: none;">{{{ template }}}</textarea>
                    <#
                    ...
                    #>
                            <div class="sntravel-group-item" style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; position: relative;">
                                <a class="sntravel-group-delete" href="#" style="position: absolute; z-index: 9; right: 10px; top: 8px;">&times;</a>
                                <div class="elementor-control elementor-label-block">
                                    <div class="elementor-control-content">
                                        <div class="elementor-control-field">
                                            <label class="elementor-control-title"><?php esc_html_e('Icon', SNTRAVEL_TEXT_DOMAIN)?></label>
                                            <div class="elementor-control-input-wrapper">
                                                <select class="elementor-control-tag-area sntravel-iconpicker">
                                                    <#
                                                    var selected = ( '' === icon_val ) ? 'selected' : '';
                                                    #>
                                                    <option value="" {{ selected }}><?php esc_html_e('No Icons', SNTRAVEL_TEXT_DOMAIN) ?></option>
                                                    <#
                                                    _.each( data.options, function( icons, group ) {
                                                    #>
                                ...
                                <div class="elementor-control elementor-label-block">
                                    <div class="elementor-control-content">
                                        <div class="elementor-control-field">
                                            <label class="elementor-control-title"><?php esc_html_e('Content', SNTRAVEL_TEXT_DOMAIN)?></label>
                                            <div class="elementor-control-input-wrapper">
                                                <input type="text" class="elementor-control-tag-area elementor-input sntravel-content-input" value="{{ content_val }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="sntravel-group-actions" style="text-align: center;">
                    <button class="elementor-button elementor-button-default sntravel-group-add" type="button">
                        <i class="eicon-plus" aria-hidden="true"></i>
                        <span><?php esc_html_e('Add Item', SNTRAVEL_TEXT_DOMAIN)?></span>
                    </button>
                </div>
            </div>
        </div>
