...
?>
<div class="sntravel-pricing-wrap <?php if (!empty($sntravel_animate)){echo esc_attr($sntravel_animate);} ?> <?php echo esc_attr($settings['style']);?>" data-wow-duration="1.4s" data-wow-delay="0.25s">
    <?php
            ...
            <div class="pricing-price-container">
                ...
                <div class="price-money-container">
                    <div class="price-money-inner">
                        ...
                        <?php
                        if (!empty($settings['pricing_table_price_separator'])){
                            ?>
