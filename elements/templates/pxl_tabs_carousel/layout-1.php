...
$widget->add_render_attribute('opts', [
    'data-settings'  => wp_json_encode([
        ...
        'dots_style' => sntravel()->get_theme_opt('swiper_pagination_style', 'style-df')
    ])
]);
...
<div class="sntravel-tabs-carousel-container">
    ...
    <?php basilico_arrow_template($settings, 'sntravel-icon zmdi zmdi-arrow-left', 'zmdi zmdi-arrow-right'); ?>
</div>