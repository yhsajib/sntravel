...
if(isset($settings['progressbar_list']) && !empty($settings['progressbar_list'])): 
    ...
    ?>
    <div id="<?php echo esc_attr($html_id) ?>" class="sntravel-progressbar">
    <?php 
    foreach ($settings['progressbar_list'] as $key => $progressbar):
        ...
        ?>
        <div class="<?php echo implode(' ', $item_cls) ?>" <?php sntravel_print_html($data_settings); ?>>
            ...
            <div class="progress-bar-wrap">
                ...
                <div <?php sntravel_print_html($widget->get_render_attribute_string( $progress_bar_key )); ?>>
