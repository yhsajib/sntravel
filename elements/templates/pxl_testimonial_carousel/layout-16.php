            ...
            <div class="sntravel-swiper-wrapper swiper-wrapper">
                <?php foreach ($content_list as $key => $value) :
                    ...
                    <div class="sntravel-swiper-slide swiper-slide">
                        <div class="item-inner relative text-start">
                            ...
                            <?php } ?>
                            <h4 class="tes-title"><?php echo sntravel_print_html($testimonial_title); ?></h4>
                            <div class="item-desc"><?php echo sntravel_print_html($description); ?></div>
                            <div class="item-wrap row gx-20 justify-content-start">
