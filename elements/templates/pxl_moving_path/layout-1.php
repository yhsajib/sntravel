...
?>
<div class="sntravel-moving-path layout-1" data-duration="<?php echo esc_attr($moving_duration); ?>">
    <?php if(! empty( $settings['selected_svg']['value'] )): ?>
        <?php \Elementor\Icons_Manager::render_icon( $settings['selected_svg'], [ 'aria-hidden' => 'true', 'class' => 'sntravel-fancy-icon sntravel-icon' ], 'i' );?>
    <?php endif; ?>
