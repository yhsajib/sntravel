...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('sntravel-single-post'); ?>>
    <div class="<?php echo esc_attr($content_inner_cls); ?>">
        <?php sntravel()->blog->get_post_metas_fastfood(); ?>
        <?php
        $custom_post_title = sntravel()->get_theme_opt('single_post_title_layout', '0');
        $post_img = sntravel()->get_theme_opt('post_feature_image_on', '1');
        ...
        <?php if (has_post_thumbnail() && esc_attr($post_img) == '1') : ?>
            <div class="post-image post-featured">
                <?php
                sntravel()->blog->get_post_feature();
        ...
        ?>
            <div class="post-tags-share d-flex align-items-center">
                ...
                <div class="post-tags-wrap col-sm-7">
                    <?php sntravel()->blog->get_post_tags(); ?>
                </div>
                <?php
                }
                if ($post_social_share == '1') { ?>
                    <div class="post-share-wrap col-sm-5">
                        <?php sntravel()->blog->get_post_share(get_the_ID()); ?>
                    </div>
                <?php 
                } 
                ?>
    ...
    <?php sntravel()->blog->get_post_nav(); ?>
</article>