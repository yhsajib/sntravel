...
class SNTRAVEL_Element_Container extends Container {
	...
	protected function content_template() {
		?>
		<#
        var sntravel_container_start = elementor.hooks.applyFilters('sntravel_container_start_render', '', settings, this);
        #>
        {{{sntravel_container_start}}}
	...
	public function before_render() {
		...
		<?php 
            $sntravel_container_start_render = apply_filters('sntravel_container_start_render','', $settings, $this);
            if(!empty($sntravel_container_start_render)) echo $sntravel_container_start_render;
        ?>
		<?php
