...
$loadmore_text = !empty( $loadmore_text ) ? $loadmore_text : esc_html__( 'View More', 'sntravel' );
...
<div class="sntravel-swiper-slider sntravel-portfolio-carousel layout-<?php echo esc_attr($settings['layout']);?> ">
    ...
    <?php if ($select_post_by === 'term_selected' && $filter == "true"): ?>
        <div class="swiper-filter-wrap <?php echo esc_attr($tab_style); ?> d-flex <?php echo esc_html($filter_alignment);?>">
                ...
                foreach ($posts as $post):
                    ...
                    <div class="sntravel-swiper-slide swiper-slide" data-filter="<?php echo esc_attr($filter_class) ?>">
                        <div class="item-inner relative">
                            ...
                            <?php endif; ?>
                            <div class="item-content remove-cursor d-flex <?php echo esc_attr($item_anm_cls) ?>" <?php sntravel_print_html($data_settings); ?>>
