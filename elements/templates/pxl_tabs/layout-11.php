...
if(count($tabs_list) > 0){
	$tab_bd_ids = [];
    ?>
    <div class="sntravel-tabs layout-11">
        ...
        <div class="tabs-title" style="background-image: url(<?php echo esc_url($settings['item_background']['url']); ?>);">
            ...
            <div class="sntravel-tab-arrows">
                <div class="sntravel-tab-arrow sntravel-tab-arrow-next"><span class="sntravel-icon zmdi-arrow-forward"></span></div>
                <div class="sntravel-tab-arrow sntravel-tab-arrow-prev"><span class="sntravel-icon zmdi-arrow-back"></span></div>
            </div>
        </div>
