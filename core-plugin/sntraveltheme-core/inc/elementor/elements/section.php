...
class SNTRAVEL_Element_Section extends Element_Section {

    protected function content_template() {
        ?>
        <#
        var custom_classes = elementor.hooks.applyFilters('sntravel-custom-section-classes', settings);
        custom_classes = _.isArray(custom_classes)?custom_classes:[];
        var sntravel_section_start = elementor.hooks.applyFilters('sntravel_section_start_render', '', settings, this);
        var sntravel_section_before = elementor.hooks.applyFilters('sntravel-custom-section/before-render', '', settings, this);
        #>
        {{{sntravel_section_start}}}
        <#
    ...
    public function before_render() {
        ...
        <?php 
            $sntravel_section_start_render = apply_filters('sntravel_section_start_render','', $settings, $this);
            if(!empty($sntravel_section_start_render)) echo $sntravel_section_start_render;
        ?>
        <?php
        ...
        $custom_classes = apply_filters('sntravel-custom-section-classes', [], $settings);
        $custom_classes = is_array($custom_classes) ? $custom_classes : [];

        $sntravel_before_section_render = apply_filters('sntravel-custom-section/before-render','', $settings, $this);

        ?>

        <?php if(!empty($sntravel_before_section_render)) echo $sntravel_before_section_render; ?>
